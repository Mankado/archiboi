import { App } from "gi://AstalGtk3"; // For app and widget-related components
import { exec, execAsync, ensureDirectory} from "gi://AstalUtils"; // For utilities
import { monitorFile } from "gi://AstalFile";
