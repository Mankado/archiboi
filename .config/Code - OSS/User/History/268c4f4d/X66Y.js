...
import { register } from './widgets/widget.js';
...
// A JavaScript version of the W() function
export default function W(Base, typename = Base.name) {
    ...
    // Return a function that creates the subclass instance
    return (props) => {
...
// Attach references to W as properties
W.register = register;
W.subclass = W;
W.Box = Box;
W.Button = Button;
